...
class UserController extends Controller
{
    public function ChannelAction(Request $request, $channel)
    {
        ...
        else
        {
            ...
            if ($userEntity)
            {
                ...
                $data = array('channel' => $userEntity->getUsername(), 'categories' => $categories, 'articles' => $articles, 'favoris' => $favoris);
    ...
    public function ResetPasswordAction(Request $request)
    {
        ...
        $this->usermodel->resetPassword($request->get('username'), $request->get('key'), $request->post('password'));
    }
