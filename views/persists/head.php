...
<link rel="stylesheet" media="only screen and (min-resolution: 400dpi)" href="<?= View::getAsset('css/responsive/form_responsive.css') ?>">
<link rel="stylesheet" media="only screen and (min-resolution: 400dpi)" href="<?= View::getAsset('css/responsive/body_responsive.css') ?>">
<link rel="stylesheet" media="only screen and (min-resolution: 400dpi)" href="<?= View::getAsset('css/responsive/fullpage_responsive.css') ?>">
